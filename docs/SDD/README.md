...
| 10 | [`10-ai-orchestrator-design.md`](10-ai-orchestrator-design.md) | Tool calling, guardrail permission, caching, eval harness, kendali biaya | [`ai-features.md`](../PRD/03-architecture/ai-features.md) | **Draft** |

...
|---|---|---|---|
| **UXD-01** | **Sidebar dikelompokkan menjadi lima grup domain kerja** (Aset & Lokasi · Pemanfaatan · Perawatan · Pengawasan · Sistem) ditambah Beranda dan Akun Saya, bukan daftar datar 21 modul | **User Decision** | Tiga modul tidak pernah menjadi entri menu dan beberapa modul memunculkan lebih dari satu entri (§3.1), sehingga pemetaan 1:1 mustahil. Struktur identik untuk semua role; yang berbeda hanya entri yang dirender (`PM-04`). **Konsekuensi:** §3.3 wajib dipelihara sebagai bukti tidak ada modul yang tertinggal |
...
| Halaman "Barang Habis Pakai" | Hanya aset tetap serialized | `NO-13` · `AS-24` |

...
- Seed: 70 permission, 7 role bawaan, `work_days`, parameter sistem
...
|---|---|
| [`roles-permissions.md`](../../PRD/00-foundation/roles-permissions.md) | Lampiran C — 70 kode permission, `PM-01` … `PM-06` |
...
| `PR-00-16` | Seed: 70 permission, 7 role, matriks, `work_days`, parameter | M | 05 | Lampiran C, `SDD-DB-10` | Uji membandingkan hasil seed dengan Lampiran C baris per baris |

...
| [01](phases/phase-01.md) | Master Data Independen | 4 | 17 | `In Progress` | 10/17 | Dimulai selagi Phase 00 `In Review` (keputusan 62); middleware otorisasi `PR-01-15` dan hash password `PR-01-16` mendahului PR endpoint (keputusan 63; keputusan 3 log phase-01); `PR-01-17` baru — impor asinkron dipisah dari `PR-01-03` (keputusan 19) |
...
| `PR-01-09` | `In Progress` | — | Ekspor activity log (XLSX, sinkron ≤ 5.000 baris) + `ACTIVITY_LOG_EXPORTED` — cabang `feature/PR-01-09-ekspor-activity-log`, keputusan 25 [log phase-01 §2](logs/phase-01.md) |

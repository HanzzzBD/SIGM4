...
| [01](phases/phase-01.md) | Master Data Independen | 4 | 18 | `In Progress` | 15/18 | Dimulai selagi Phase 00 `In Review` (keputusan 62); middleware otorisasi `PR-01-15` dan hash password `PR-01-16` mendahului PR endpoint (keputusan 63; keputusan 3 log phase-01); `PR-01-17` baru — impor asinkron dipisah dari `PR-01-03` (keputusan 19) |
...
| `PR-01-14` | `In Progress` | [#58](https://github.com/HanzzzBD/SIGM4/pull/58) | Gerbang persetujuan wali: `users.consent_guardian_at`, akun siswa tanpa penanda tidak dapat dibuat/diaktifkan (DP-02, SL-06); `NT-48` ditunda ke M-17 — keputusan 32 [log phase-01 §2](logs/phase-01.md) |

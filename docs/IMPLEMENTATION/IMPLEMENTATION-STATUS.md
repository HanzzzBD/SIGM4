...
| [01](phases/phase-01.md) | Master Data Independen | 4 | 18 | `In Progress` | 14/18 | Dimulai selagi Phase 00 `In Review` (keputusan 62); middleware otorisasi `PR-01-15` dan hash password `PR-01-16` mendahului PR endpoint (keputusan 63; keputusan 3 log phase-01); `PR-01-17` baru — impor asinkron dipisah dari `PR-01-03` (keputusan 19) |
...
| `PR-01-13` | `In Review` | [#57](https://github.com/HanzzzBD/SIGM4/pull/57) | Siklus akun siswa: `student_enrollments`, kenaikan kelas massal, penonaktifan lulusan, titik ekstensi kewajiban (SL-04) — keputusan 30 [log phase-01 §2](logs/phase-01.md) |

...
| `PR-01-02` | `In Progress` | — | CRUD pengguna + soft delete + aturan Administrator terakhir; cabang `feature/PR-01-02-crud-pengguna-soft-delete` — keputusan 16–17 [log phase-01 §2](logs/phase-01.md) |

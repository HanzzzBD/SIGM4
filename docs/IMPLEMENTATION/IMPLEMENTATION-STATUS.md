...
| `PR-01-09` | `In Review` | [#53](https://github.com/HanzzzBD/SIGM4/pull/53) | Ekspor activity log (XLSX, sinkron ≤ 5.000 baris) + `ACTIVITY_LOG_EXPORTED` — keputusan 25 [log phase-01 §2](logs/phase-01.md) |

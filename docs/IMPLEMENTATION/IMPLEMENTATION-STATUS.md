...
| `PR-01-11` | `In Progress` | — | Kalender akademik: skema `academic_years`/`academic_terms` + `holidays.academic_year_id`, invariant tepat-satu-aktif di DB, tanpa endpoint — cabang `feature/PR-01-11-kalender-akademik`, keputusan 27 [log phase-01 §2](logs/phase-01.md) |

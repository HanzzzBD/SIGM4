...
| `PR-01-18` | `In Progress` | — | Endpoint master data Lampiran E: tahun ajaran & semester, hari libur, hari kerja, unit kerja *(baru, keputusan 29)* — menutup butir terbuka `PR-01-11`/`PR-01-12` ; 14 endpoint M-20 tanpa migration — keputusan 34 [log phase-01](logs/phase-01.md) |

...
| `PR-01-10` | `In Progress` | — | `system_settings` + seed parameter bawaan + `GET/PUT /settings` + validasi rentang — cabang `feature/PR-01-10-system-settings`, keputusan 26 [log phase-01 §2](logs/phase-01.md) |

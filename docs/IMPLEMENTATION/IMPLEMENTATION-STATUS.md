...
| `PR-01-14` | `In Progress` | — | Gerbang persetujuan wali: `users.consent_guardian_at`, akun siswa tanpa penanda tidak dapat dibuat/diaktifkan (DP-02, SL-06); `NT-48` ditunda ke M-17 — keputusan 32 [log phase-01 §2](logs/phase-01.md) |

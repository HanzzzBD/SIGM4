...
| [01](phases/phase-01.md) | Master Data Independen | 4 | 16 | `In Progress` | 2/16 | Dimulai selagi Phase 00 `In Review` (keputusan 62); middleware otorisasi `PR-01-15` dan hash password `PR-01-16` mendahului PR endpoint (keputusan 63; keputusan 3 log phase-01) |
...
| `PR-01-02` | `In Review` | [#46](https://github.com/HanzzzBD/SIGM4/pull/46) | CRUD pengguna + soft delete + aturan Administrator terakhir; cabang `feature/PR-01-02-crud-pengguna-soft-delete` — keputusan 16–17 [log phase-01 §2](logs/phase-01.md) |

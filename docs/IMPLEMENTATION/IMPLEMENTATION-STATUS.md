...
| [01](phases/phase-01.md) | Master Data Independen | 4 | 17 | `In Progress` | 8/17 | Dimulai selagi Phase 00 `In Review` (keputusan 62); middleware otorisasi `PR-01-15` dan hash password `PR-01-16` mendahului PR endpoint (keputusan 63; keputusan 3 log phase-01); `PR-01-17` baru — impor asinkron dipisah dari `PR-01-03` (keputusan 19) |
...
| `PR-01-07` | `In Review` | [#51](https://github.com/HanzzzBD/SIGM4/pull/51) | Daftar aset per lokasi (kerangka), modul `m04-assets` lahir pertama kali — keputusan 23 [log phase-01 §2](logs/phase-01.md) |

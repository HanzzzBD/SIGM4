...
| `PR-01-03` | `In Progress` | — | Impor massal pengguna (CSV/XLSX), sinkron ≤ 200 baris; cabang `feature/PR-01-03-impor-massal-pengguna` — keputusan 19 [log phase-01 §2](logs/phase-01.md) |

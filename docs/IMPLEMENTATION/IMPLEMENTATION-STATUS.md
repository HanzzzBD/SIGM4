...
| [02](phases/phase-02.md) | Inti Sistem | 5 | 30 | `In Progress` | 5/30 | Phase terbesar; di lintasan kritis. Dipensiunkan: `PR-02-01` → `PR-01-16`, `PR-02-09` → `PR-01-15`; `PR-02-31` baru (keputusan 9 log phase-01) |
...
| Rilis (`main`) yang memuat `PR-02-07` | PR reset-2FA / menonaktifkan 2FA (`FR-01.5 A3`, `POST /users/{id}/reset-2fa`) tergabung, dan keputusan PRD atas pengikatan pendaftaran 2FA pertama (log phase-02 keputusan 44–45). Tanpa reset, pendaftaran oleh pemegang password tak punya jalur pemulihan biasa | 20 September 2026 | Pemilik produk |

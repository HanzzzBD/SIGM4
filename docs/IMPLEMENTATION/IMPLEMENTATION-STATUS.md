...
|:---:|---|:---:|:---:|---|:---:|---|
| [00](phases/phase-00.md) | Foundation | — | 18 | `In Progress` | 4/18 | `PR-00-01` … `PR-00-04` tergabung; `PR-00-05` menunggu tinjauan; keputusan stack `PR-00-06` … `PR-00-18` seluruhnya terkunci |
...
| `PR-00-05` | `In Review` | — | Migration runner + `0001` ekstensi + `0002` enum |

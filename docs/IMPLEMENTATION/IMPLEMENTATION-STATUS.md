...
| `PR-01-07` | `In Review` | — | Daftar aset per lokasi (kerangka), modul `m04-assets` lahir pertama kali — keputusan 23 [log phase-01 §2](logs/phase-01.md) |

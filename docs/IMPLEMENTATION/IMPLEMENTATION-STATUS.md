...
| [02](phases/phase-02.md) | Inti Sistem | 5 | 31 | `In Progress` | 13/31 | Phase terbesar; di lintasan kritis. Dipensiunkan: `PR-02-01` → `PR-01-16`, `PR-02-09` → `PR-01-15`; `PR-02-31` baru (keputusan 9 log phase-01); `PR-02-33` baru (keputusan 48 log phase-02) |
...
| `PR-02-15` | `In Review` | — | Manajemen kategori aset (`FR-04.5`): `GET/POST /asset-categories`, `PUT/DELETE /asset-categories/{id}` — tiga endpoint tulis + A3/A4 dinaikkan ke PRD lebih dulu (keputusan 62). A1 kode unik, A2 kategori terpakai tak dapat dihapus, A3 induk bersubkategori tak dapat dihapus, A4 kode kategori terpakai tetap, siklus induk ditolak. Tanpa migration. Kompleksitas `S` → `L` (log §3) |
| `PR-02-16` … `PR-02-32` | `Not Started` | — | Rincian: [`phases/phase-02.md` §7](phases/phase-02.md) |

...
|---|---|---|---|
| **audit_sessions** | Sesi stock opname | id, nomor (`OPN`, `SEQ-01`), nama, **domain (ASET/BAHAN — `BR-093`)**, periode_mulai, periode_selesai, cakupan (JSON), pelaksana_id, status, disetujui_oleh, disetujui_pada | ± 8 |

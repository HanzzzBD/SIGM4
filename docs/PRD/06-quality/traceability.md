...
| `FR-01.5` | M-01 Autentikasi & Manajemen Akun | `02-modules/m01-auth.md` | In Progress | PR-02-07 (#68): alur utama 1–5, A1, A2 dan AC kode cadangan/peringatan ≤ 2. PR-02-33 (#69): A3 (reset 2FA), A5, A7 (kode aktivasi). TERBUKA: A6 (CLI penerbit kode aktivasi — PR-02-08) dan menonaktifkan 2FA sendiri — belum ada PR (logs/phase-02.md §10) |
| `FR-01.6` | M-01 Autentikasi & Manajemen Akun | `02-modules/m01-auth.md` | In Progress | PR-02-08 (belum digabung): admin:recover (guard admin lain aktif, 2FA dilepas, password+kode aktivasi baru, sesi sistem dicabut, NT-53), diuji |
...
| `BR-070b` | M-01 Autentikasi & Manajemen Akun | `02-modules/m01-auth.md` | In Progress | PR-02-08 (belum digabung): sigm4 admin:recover, CLI-only, diuji |
| `BR-070c` | M-01 Autentikasi & Manajemen Akun | `02-modules/m01-auth.md` | Done | PR-02-07 (#68): hash Argon2id, tampil sekali; diuji |
| `BR-070d` | M-01 Autentikasi & Manajemen Akun | `02-modules/m01-auth.md` | In Progress | PR-02-33 (#69): enroll/confirm role wajib menuntut kode aktivasi; endpoint penerbit + reset 2FA; diuji. TERBUKA: CLI penerbit kode aktivasi (PR-02-08) |

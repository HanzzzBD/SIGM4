...
| **M4 — Kontrol & Siklus Hidup Sarpras** | M-13, M-14, M-21, **M-22** | Sesi opname 1.000 unit selesai di perangkat nyata; usulan pengadaan menghasilkan aset; penghapusan menghasilkan berita acara; permintaan bahan berujung penyerahan dengan saldo per lokasi yang tepat, hanya berubah lewat transaksi dan tidak pernah negatif (`BR-081`, `BR-082`, `BR-083`) |

...
| RS-08 | Biaya penggunaan Gemini API membengkak melebihi anggaran | Biaya | Sedang | Sedang | Batas percakapan harian per pengguna, konteks dibatasi 10 pesan, pemantauan penggunaan token pada dashboard Administrator, dan pengalih untuk menonaktifkan chatbot |

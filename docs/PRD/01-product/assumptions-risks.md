...
| AS-15 | Tersedia akun Firebase untuk push notification dan akun **Google Gemini Developer API** untuk chatbot. Sejak 2 September 2026 tier gratis diizinkan (DP-AI-04) sehingga anggaran penggunaan **tidak lagi menjadi prasyarat**; sebagai gantinya kuota dan batas laju tier gratis menjadi batasan operasional yang ditanggung AI-CTL-06 dan RS-08. |
...
| RS-08 | Kuota atau batas laju Gemini API habis sehingga chatbot berhenti melayani; pada tier berbayar, tagihan membengkak melebihi anggaran | Ketersediaan | Sedang | Sedang | Batas percakapan harian per pengguna, konteks dibatasi 10 pesan, pemantauan penggunaan token pada dashboard Administrator, dan pengalih untuk menonaktifkan chatbot |
...
| RS-21 | Gemini Developer API tidak menjamin residensi data; prompt dan hasil tool chatbot dapat diproses atau di-*cache* di yurisdiksi mana pun tempat penyedia memiliki fasilitas | Kepatuhan | Sedang | Tinggi | DPA penyedia; konteks yang dikirim sudah dibatasi role & scope tanpa identitas pribadi (DP-AI-01) dan disaring *field allow-list* (DP-AI-02). Persetujuan tertulis sekolah atas pemrosesan lintas yurisdiksi **sudah diberikan 2 September 2026** — `TBD-AI-D` tertutup (`SDD-AI-16`). Sejak DP-AI-04 disunting pada tanggal yang sama, mitigasi *tanpa pemakaian untuk pelatihan model* **tidak lagi berlaku**: isi percakapan dapat dipakai penyedia untuk meningkatkan produknya. Jalur *scope-cut* tetap menonaktifkan chatbot lewat `AI-CTL-09` |

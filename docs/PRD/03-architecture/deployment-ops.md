...
| OBS-04 | *Uptime monitoring* eksternal atas `/health/live` setiap 60 detik — probe inilah yang publik; `/health` menuntut `setting.view` karena membeberkan status dependensi |
